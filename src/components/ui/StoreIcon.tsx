...
// Recreación del glifo "store-alt" de Font Awesome Free (CC BY 4.0), inline
// para no depender de un archivo externo ni de una librería de íconos nueva.
export function StoreIcon({ size = 20, className }: StoreIconProps) {
  return (
    <svg
